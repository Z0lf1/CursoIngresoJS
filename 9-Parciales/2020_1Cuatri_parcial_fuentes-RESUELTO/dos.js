...
//b) el importe total a pagar con descuento(solo si corresponde)
  ...
  document.write("El importe bruto a pagar en es: "+importeBruto+ "<br>");//a.
  document.write("Siendo entonces el importe final con descuento aplicable: "+importeTotal+ "<br>"); //b.
  document.write("La mayor cantidad de bolsas es de: "+tipoConMasCantidad+ "<br>");//d.
  document.write("siendo el mas caro el tipo: "+tipoMasCaro+ "<br>");//f.
